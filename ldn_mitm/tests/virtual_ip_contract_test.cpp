...
using ams::mitm::ldn::relay::VirtualIpBroadcast;
using ams::mitm::ldn::relay::VirtualIpNetmask;
...
int main() {
    ...
    assert(VirtualIpNetmask == 0xFFFF0000u); // 255.255.0.0
    assert(VirtualIpBroadcast(0x0A0D0021u) == 0x0A0DFFFFu);
}
